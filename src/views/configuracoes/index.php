                ...
                <div class="p-6">
                    <form method="POST" action="/configuracoes/salvar">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div>
                                <label class="block text-sm font-medium text-gray-700 mb-2">Meta de Vendas Diaria (R$)</label>
                                <input type="number" step="0.01" name="meta_venda_diaria" value="<?= e(old('meta_venda_diaria', $configs['meta_venda_diaria'] ?? '1000')) ?>" class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-primary focus:border-transparent">
                            </div>
                        </div>
